...
let g:navigator.v = {
    ...
    \ 'q' : ['Vimrc#EditInitVimrc("packages.vim")', 'packages.vim'],
...
let g:navigator.0 = {
    \ 'name': '+vimTweak',
    \ '0' : [':VimTweakSetAlpha 255', '不透明'],
    \ '1' : [':VimTweakSetAlpha 245', '透明度+10'],
    \ '2' : [':VimTweakSetAlpha 235', '透明度+20'],
    \ '3' : [':VimTweakSetAlpha 225', '透明度+30'],
    \ '4' : [':VimTweakSetAlpha 215', '透明度+40'],
    \ '5' : [':VimTweakSetAlpha 205', '透明度+50'],
    \ '6' : [':VimTweakSetAlpha 195', '透明度+60'],
    \ '7' : [':VimTweakSetAlpha 185', '透明度+70'],
    \ '8' : [':VimTweakSetAlpha 175', '透明度+80'],
    \ '9' : [':VimTweakSetAlpha 165', '透明度+90'],
