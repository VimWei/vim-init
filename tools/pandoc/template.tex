...
\setCJKmainfont{思源宋体}   % 設定中文字型
\setCJKsansfont{思源黑体}   % 設定中文字型
\setmainfont{思源宋体}      % 設定英文字型
\setsansfont{思源黑体}      % 設定英文字型
% \setCJKmainfont{Microsoft YaHei}   % 設定中文字型
% \setCJKsansfont{Microsoft YaHei}   % 設定中文字型
% \setmainfont{Microsoft YaHei}      % 設定英文字型
% \setsansfont{Microsoft YaHei}      % 設定英文字型
% 【列示】第二种设置
