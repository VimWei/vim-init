...
command! VQ call Vimrc#EditInitVimrc("packages.vim")
...
command! -nargs=1 -complete=command -range Redir silent call Redir#redir(<q-args>, <range>, <line1>, <line2>)
command! RedirMessage silent Redir messages
