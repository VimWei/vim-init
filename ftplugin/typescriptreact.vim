" TSX (TypeScript + JSX) folding - cached expr fold, see autoload/JsTsFold.vim
" Reuses the JS/TS scanner; JSX closing tags (</tag>) are not mistaken for
" regexes, and JSX expression braces are tracked like ordinary braces.
"
